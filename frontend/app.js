...
const consentManagementAddress = "0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0"; // Example, use your deployed address
const patientRecordsAddress = "0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512"; // Example, use your deployed address

// --- Contract ABIs ---
// IMPORTANT: Ensure these are the complete and correct ABI arrays from your artifact JSON files.
const consentManagementABI = [
    {
      "inputs": [
        {
          "internalType": "address",
          "name": "_purposeTreeAddress",
          "type": "address"
        },
        {
          "internalType": "address",
          "name": "_patientRecordsAddress",
          "type": "address"
        }
      ],
    ...
    },
    {
      ...
      "inputs": [
        ...
        {
          "indexed": false,
          "internalType": "enum ConsentManagement.Action",
          "name": "action",
          "type": "uint8"
        },
        {
    ...
    },
    {
      ...
      "outputs": [
        {
          "internalType": "contract PurposeTree",
          "name": "",
          "type": "address"
        }
      ],
    ...
    },
    {
      "inputs": [
        ...
        {
          "internalType": "uint256",
          "name": "internalConsentCounter",
          "type": "uint256"
        }
      ],
      "name": "revokeConsentByInternalId",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    }
  ];
const patientRecordsABI = [
    {
      "anonymous": false,
      "inputs": [
        {
